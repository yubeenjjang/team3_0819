...
travel_tool_page = st.Page("app_pages/13_travel_tool_use.py", title="여행 계획 Tool Use")
...
navigation = st.navigation(
    [home_page, concept_page, travel_page, environment_page, llm_page, provider_page,
     prompt_page, validation_page, structured_page, map_travel_page, travel_tool_page,
     image_page, tts_page],
    position="hidden",
)
