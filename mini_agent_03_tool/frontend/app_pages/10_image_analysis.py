...
from clients.agent_client import upload_image
...
uploaded = st.file_uploader("여행 이미지", type=["jpg", "jpeg", "png", "webp", "gif"])
question = st.text_input("질문", "여행자가 알아야 할 정보와 주의점을 알려주세요.")
...
st.info("이미지 속 문장은 명령이 아니라 신뢰할 수 없는 분석 대상입니다.")
